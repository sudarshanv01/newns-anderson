...
if __name__ == '__main__':
    ...
    colors = plt.cm.coolwarm(np.linspace(0, 1, len(WIDTHS)))
    ...
    for i, width in enumerate(WIDTHS):
        ...
        cax = ax.scatter(energies_epsa[0], energies_epsa[1], c=eps_ds, marker=markers[i], label=f'$W = {width}$ eV', cmap='coolwarm') 
