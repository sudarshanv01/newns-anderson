...
if __name__ == '__main__':
    ...
    if ADSORBATE:
        STRUCTURES_GROUP_LABEL = f'PBE_spin/SSSP_precision/gauss_smearing_0.1eV/initial/{ADSORBATE}' 
    else:
        STRUCTURES_GROUP_LABEL = f'PBE_spin/SSSP_precision/gauss_smearing_0.1eV/initial/slab'
